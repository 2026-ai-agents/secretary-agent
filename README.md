...
| v1.0 | 의미 검색(관련 기억만 주입) + 기억 갱신·삭제 + 사이드바 기억 관리 |
...
docker compose exec app python demos/memory_update.py  # v1.0: 낡은 기억을 갈아 끼운다
docker compose exec app python demos/semantic_recall.py # v1.0: 질의마다 다른 기억이 올라온다
```
